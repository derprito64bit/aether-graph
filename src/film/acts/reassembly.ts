...
export const REASSEMBLY_KEYS: FilmKey[] = [
  key({
    at: 0.755,
    pose: { rx: -1.0, ry: 1.0, rz: 0.03, scale: 1.3, px: 0, py: 0.05 },
    camera: { pos: [0, 0.15, 0.62], target: [0, -0.01, -0.01] },
    lens: { fov: 24, fit: 0.6 },
    look: { exposure: 1.1 },
  }),
  key({
    at: 0.795,
    pose: { rx: -0.6, ry: 0.7, rz: -0.1, scale: 1.45, px: 0, py: 0.05 },
    camera: { pos: [0, 0.08, 0.68], target: [0, 0, 0] },
    lens: { fov: 22, fit: 0.62 },
    look: { exposure: 1.1 },
  }),
  key({
    at: 0.84,
    pose: { rx: -0.35, ry: 0.5, rz: -0.3, scale: 1.55, px: 0, py: 0.055 },
    camera: { pos: [0, 0.03, 0.7], target: [0, 0.01, 0] },
